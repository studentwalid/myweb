...
class Hustle_Layout_Helper {
	 ...
	 * @return void
	 */
	private function branding_image() {
		$this->branding_image = apply_filters( 'wpmudev_branding_hero_image', true );
		// if branding_image is empty set is_branding_hidden false.
		if ( empty( $this->branding_image ) ) {
			$this->is_branding_hidden = false;
		}
	}
